...
Now we need Python and [[https://github.com/RDFLib/rdflib][rdflib]] to parse the data:
...
memory and this requires an enormous amount of main memory (200GB).
...
the ~isbd:P1053~ property which holds the number of pages:
...
<http://d-nb.info/1010791265> a bibo:Document ;
        ...
        dc:title "Los pájaros de Baden-Baden" ;
