...
#+BEGIN_SRC sh
  for publisher in $(awk -F'\t' '{print $2}' publisher_map.tsv | sort -u | sed "s/ /###/g"); do
    ...
    awk -F'\t' -v p="$publisher" '{if ($3 == p) print $2"\t hier dann Titel, Autor, Jahr"}' publisher_data.tsv
  done
#+END_SRC
...
|  4025 | Hanser                      |
| 23728 | Heyne                       |
|  2999 | Hoffmann und Campe          |
|  9697 | Insel                       |
|  3056 | Kiepenheuer & Witsch        |
|  2816 | Luchterhand Literaturverlag |
|  1205 | Manesse                     |
|   185 | Merve                       |
|   475 | Nagel & Kimche              |
|  9388 | Piper                       |
...
| 15383 | Suhrkamp                    |
| 11685 | Ullstein                    |
|   105 | Urs Engeler Editor          |
|   144 | Verbrecher Verlag           |
|    39 | Voland & Quist              |
|   562 | Wallstein                   |
|   147 | Wiesenburg                  |
