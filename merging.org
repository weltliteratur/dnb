...
#+BEGIN_SRC sh
  ./json2json.py -f -p "issued,pages_norm,publisher,creator_wd.*.occupation_writer" \
		 DNBTitel_normalised_enriched.json.gz \
...
| Ullstein                           |  3117354 | 10706 |        291 |
| Fischer-Taschenbuch-Verl.          |  3105059 |  9550 |        325 |
| Reclam                             |  3082447 | 17852 |        172 |
| Piper                              |  2843569 |  9257 |        307 |
| RM-Buch-und-Medien-Vertrieb [u.a.] |  2242582 |  5631 |        398 |
| Herder                             |  1925130 |  9702 |        198 |
| Weltbild                           |  1858937 |  4388 |        423 |
| Büchergilde Gutenberg              |  1711924 |  5062 |        338 |
| Beck                               |  1691647 |  5130 |        329 |
| Insel-Verl.                        |  1611640 |  6954 |        231 |
| Dt. Buch-Gemeinschaft              |  1475774 |  4287 |        344 |
| S. Fischer                         |  1334634 |  4519 |        295 |
...
plot 'publisher_pages_stats.tsv' using 2:3 with points pt 7 title ''
...
*** TODO normalisation
**** TODO mapping table
Extract data about all publishers:
#+BEGIN_SRC sh :results silent
  ./json2json.py -f -p "issued,pages_norm,publisher,creator_wd.*.occupation_writer" \
                 DNBTitel_normalised_enriched.json.gz \
...
("D A Wallstein" seems to have contained a TAB between "D" and "A")
