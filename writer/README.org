...
#+BEGIN_SRC sh :results silent
  ./json2json.py -f \
		 ...
		 DNBTitel_normalised_enriched.json.gz \
      | awk -F'\t' '{if ($1 >= 1913) {gsub(/,.*/, "", $4); print $3"\t"$4"\t"$2}}' \
	    > author_occupations.tsv
#+END_SRC

Count:
#+BEGIN_SRC sh
  LC_ALL=C datamash -s -g1,2 count 3 mean 3 sum 3 < author_occupations.tsv > author_occupations_stats.tsv
  awk -F'\t' '{sum[$2]+=$5; count[$2]+=1; pcount[$2]+=$3} END {for (p in sum) printf("%s\t%s\t%s\t%s\t%s\n", count[p], pcount[p], sum[p], int(sum[p]/pcount[p]), p)}' author_occupations_stats.tsv > occupations_stats.tsv
  sort -rn occupations_stats.tsv | head -n20
#+END_SRC

Plot:
#+TBLNAME:occupations
| occupation                  | people |  books |     pages | mean pages |
|-----------------------------+--------+--------+-----------+------------|
| writer                      |  23988 | 502389 | 115075229 |        229 |
| journalist                  |   7040 |  96522 |  23122118 |        239 |
| historian                   |   4691 |  33445 |   8407044 |        251 |
| theologian                  |   3304 |  51627 |   9778274 |        189 |
| poet                        |   2794 |  63918 |  12729171 |        199 |
| art historian               |   2287 |  21165 |   3776973 |        178 |
| screenwriter                |   2051 |  41553 |  10150555 |        244 |
| non-fiction writer          |   1740 |  26179 |   6024093 |        230 |
| translator                  |   1535 |  26961 |   5539519 |        205 |
| novelist                    |   1211 |  37813 |  12025521 |        318 |
| archaeologist               |    982 |   6205 |   1123262 |        181 |
| historian of the modern age |    737 |   7808 |   2233148 |        286 |
| television presenter        |    680 |   7556 |   1701370 |        225 |
| medievalist                 |    502 |   4210 |   1031582 |        245 |
| church historian            |    463 |   4713 |   1013817 |        215 |
| playwright                  |    452 |  25094 |   5112597 |        203 |
| opinion journalist          |    441 |   5110 |   1033536 |        202 |
| regional historian          |    387 |   3299 |    662127 |        200 |
| legal historian             |    330 |   3226 |    766138 |        237 |
| literary historian          |    315 |   3802 |    907947 |        238 |
...
set ylabel 'mean number of pages'
